...
public class SpeechRecognizer extends Plugin {
    ...
    private void getSupportedLanguages() {
    	...
    	((DroidGap)this.ctx).getApplicationContext().sendOrderedBroadcast(intent, null, hintReceiver, null, Activity.RESULT_OK, null, null);
	}
    ...
    private boolean isSpeechRecognizerPresent() {
        PackageManager pm = ((DroidGap)this.ctx).getPackageManager();
    ...
    private void startSpeechRecognitionActivity(JSONArray args) {
        ...
        ((DroidGap)this.ctx).startActivityForResult(this, intent, reqCode);
    }
